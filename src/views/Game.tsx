                            ...
                            <Col lg="5" className="mt-6 mb-6 ml-6">
                                <Row className="mt-3">
                                    <Col lg="9" className="center">
                                        ...
                                        <Button style={{width: "25em", height: "25em"}} >
                                            <svg width="15em" height="15em" viewBox="0 0 16 16" className="bi bi-controller" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Row className="mt-5">
                                    <Col lg="6" className="center">
                                        <p style={{textAlign: "center", fontSize: "35px", fontWeight: "bold"}} className='text-success'>Play Game</p>
                                    </Col>
                                </Row>
                            </Col>
                            <Col lg="5" className="mt-6 mb-6 ml-6">
                                ...
                                <Row className="mt-5">
                                    <Col lg="6" className="center">
                                        <p style={{textAlign: "center", fontSize: "35px", fontWeight: "bold"}} className='text-primary'>Create Game</p>
                                    </Col>
                                </Row>
                            </Col>
